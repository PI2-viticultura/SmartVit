...
buraco e preparar o concreto conforme os passos mostrados na Figura 2 dentro da forma de madeira:
...
3 nessa direção com o auxílio de uma bússola.
...
O poste principal que chegará para a instalação já estará pré furado,
  ...
  de instalação conforme apresentado na Figura 3.
  ...
  Na Figura 3 as letras representam:
  ...
  **PLACA SOLAR**
  ...
  1.  Deve-se colocar as duas cantoneiras de 668 mm paralelas uma à outra
      ...
      formando uma estrutura em "H", conforme ilustrado na Figura 4,
  ...
  2.  Parafusar com 4 parafusos M8 a placa solar na estrutura em "H"
       utilizando os furos indicados por (4) na Figura 5.
  ...
  3.  Fixar o sistema da placa solar através da cantoneira de 308,5 mm no
      ...
      é possível observar na Figura 6. A altura de fixação da
  ...
  4.  Antes de apertar as porcas da abraçadeira é necessário verificar a angulação
...
Tabela 2 - Componentes necessários para a instalação do sistema anemômetro/biruta. (Fonte: Autoria Própria)
  ...
  1.  Fixar o poste retangular, no qual a biruta e o anemômetro já são
      fixados que representado por (6) na Figura 7 no poste auxiliar.
  ...
  **FIXAÇÃO DOS POSTES AUXILIARES NO PRINCIPAL**
  ...
  1.  Acoplar os postes nos seus respectivos perfis UDC, na Figura 3 (b) representa o da placa solar
...
Tabela 4 - Componentes necessários para a instalação do pluviômetro. (Fonte: Autoria Própria)
  ...
  1.  Fixar o pluviômetro na estrutura em "L"  pré soldada no poste
      principal (indicada por (e) na Figura 3) conforme mostrado na Figura
      9 utilizando 4 parafusos M8.
  ...
  **SENSOR DE TEMPERATURA**
  ...
  A Tabela 5 indica os componentes e suas quantidades necessárias para a fixação da estrutura 3D do sensor de temperatura:
...
Tabela 5 - Componentes necessários para a instalação do sensor de temperatura. (Fonte: Autoria Própria)
  ...
  1.  Fixar a estrutura 3D na estrutura em "L"  pré soldada no poste
      principal(indicada por (a) na Figura 3), indicada por (12) na Figura 10, utilizando 4 parafusos M6.
  ...
  **GABINETE**
  ...
  A Tabela 6 indica os componentes e suas quantidades necessárias para a fixação do gabinete:
...
Tabela 6 - Componentes necessários para a instalação do gabinete. (Fonte: Autoria Própria)
  ...
  1.  Fixar o gabinete na placa pré soldada indicada por (14) na
      Figura 11 e por (d) na Figura 3, utilizando 4 parafusos M8.
  ...
  **SISTEMA DE IRRIGAÇÃO**
  ...
  Para instalação do sistema de irrigação o usuário deve garantir que a pressão de entrada do sistema é de 100 kPa a 500 kPa. São necessários os itens apresentados na Tabela 7 para a sua instalação:
...
Tabela 7 - Componentes necessários para a instalação do sistema de irrigação. (Fonte: Autoria Própria)
  ...
  4. A Figura 13 apresenta o diagrama hidráulico do sistema de irrigação
